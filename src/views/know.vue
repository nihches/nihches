...
<template>
  <div class="knowland">
    <div class="sideNav" id="isMeni" v-show="sMeni">
      <div class="sideOption" v-for="story in fragments" @click="switchFragment(story.name)">
        <div >
          {{ story.name }}
        </div>
      </div>
